...
export const itemsTimeline = [
    {
        time: '26/05/1991',
        title: 'Ngày chào đời',
        content: `Mình là em bé mới sinh ra trong gia đình có 5 người.
        Mình có ba, mẹ và 2 anh trai, còn tôi thì là em út của gia đình.
    ...
    },
    {
        time: '1997-2001',
        title: 'Học cấp I',
        content: `Trường mình học là trường Tiểu Học Trung Dũng
            -- 1997 Học lớp 1 (Học lực khá).
            -- 1998 Học lớp 2 (Học lực khá).
            -- 1999 Học lớp 3 (Học lực tb - Xém ở lại lớp vì trốn học đi chơi quá nhiều).
    ...
    },
    {
        time: '2002-2005',
        title: 'Học cấp II',
        content: `Trường mình học là trường Trung hoc Cơ sở Sông Ray.
            -- 2002 Học lớp 6 (Học lực trung bình).
            -- 2003 Học lớp 7 (Học lực trung bình).
    ...
    },
    {
        time: '2006-2008',
        title: 'Học cấp III ',
        content: `Trường mình học là trường Trung hoc Phổ thông Sông Ray.
            -- 2006 Học lớp 10 (Học lực trung bình).
    ...
    {
        time: '2009-2012',
        title: 'Học cao đẳng nghề',
        content: `Trường mình học là trường cao đẳng nghề Việt Nam - Singapore.
            -- 2009 với nguyện vọng duy nhất là thi và trường cao đẳng kỹ thuật Cao Thắng, nhận được giấy báo trúng tuyển hệ cao đẳng nhưng không có điều kiện theo học ở Sài Gòn nên nộp học bạ xét vào trường cao đẳng nghề Việt Nam - Singapore (Bình Dương) với chuyên ngành Điện-Điện tử Công nghiệp.(hồi đó nghe tên trường cũng rén vì sợ học phí cao nhưng tới tìm hiểu thì tiền học khá rẻ) Thế là bước vào cuộc đời sinh viên.
            -- 2009 Học năm nhất, vừa học vừa làm không lương, bao ăn ở tại 1 studio (chụp hình,shotoshop) được người quen giới thiệu ở Bình Chuẩn, Thuận An , Bình Dương (cuối năm nhất tổng kết nhận được 1 phần học bổng trị giá 1 triệu Vnđ luôn đó nha).
            -- 2010 Học năm hai, vì 1 số lý do dọn ra ngoài nhà trọ cùng với đám bạn và cũng không làm tại studio nữa. Kiếm việc thời vụ làm ban đêm và làm tại 1 xưởng sản xuất giày da làm được 2 tháng thì đủ chỉ tiêu và hết việc. Sau đó kiếm và xin được vào làm tại 1 quán ăn tại Thủ Dầu Một. Làm đủ thứ từ rửa chén chuyển qua giữ xe qua order qua tiếp thực, phụ bếp, lâu lâu bà chủ đi kéo xì dzách cũng lên ngồi thu ngân luôn.(cuối năm hai tổng kết cũng nhận được 1 phần học bổng trị giá 1 triệu Vnđ).
    ...
    },
    {
        ...
        title: `Thất nghiệp`,
        content: `Tới khoảng thời gian có thể nói khá là tồi tệ :
